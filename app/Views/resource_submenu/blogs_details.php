	...
	<div class="row padd-5">
		<div class="col-md-8 z-index_blog padd-bottom-10">
			...
			<div class="padding-top-5">
				<img class="w-100 blog_img" src="<?php echo base_url('admin/writable/blog_thumbnail').'/'.$blogDetail[0]['thumbnail_img'];?>">
			</div>
			<div class="para_about text-justify">
				<?php  $strlen = strlen($blogDetail[0]['description']); $array = str_split($blogDetail[0]['description'], ($strlen/2));?>
