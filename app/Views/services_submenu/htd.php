		...
		<div class="container ">
			...
			<div class="row">
				...
				<div class="col-12 col-sm-12 col-lg-6" data-aos="fade-left" data-aos-offset="300" data-aos-delay="50" data-aos-duration="1000" data-aos-delay="50" data-aos-duration="1000">
					...
					<p class="para_about">
						At the first level, we conduct interviews and shortlisting to zero in on just the type of talent the client is looking for. This screening process helps in filtering out the best candidates who match the requirements of the client.
					</p>
					<p class="para_about">
						We have partnered with hundreds of government and private colleges in India to pick out the best pool of candidates from the IT arena. We make use of innovative assessment and profiling tools & techniques to filter out the best of the best candidates for the client's requirements.
					</p>
				</div>
			</div>
		</div>
	...
	<section class="htd_sec3" >
		...
		<div class="htd_white_text">
			...
			<img class="w-100 htd_img" data-aos="zoom-in" data-aos-offset="300" data-aos-delay="50" data-aos-duration="1000" data-aos-delay="50" data-aos-duration="1000" src="<?php echo base_url('user/assets/img/HTD/section_3/logos_web.png');?>">
		...
		<div class="container" >
			<div class="row padding_b-5">
				...
				<div class="col-12 col-sm-12 col-lg-6" data-aos="fade-left" data-aos-offset="300" data-aos-delay="50" data-aos-duration="1000" data-aos-delay="50" data-aos-duration="1000">
					...
					<p class="para_about">
						At the first level, we conduct interviews and shortlisting to zero in on just the type of talent the client is looking for. This screening process helps in filtering out the best candidates who match the requirements of the client.After the successful completion of the training, candidates ore fully ready for the project or technical requirements. The client now conducts the final assessment of the cordidotes. Since these condicates are rigorously trainec, there remains a minor scope of error. Due to this, the bounce rate remors minimo. We ciso train around 20% of curdideles as buffers to ensure precision in the torget achievement assigned by the client. We also do this to provice a broader and more accurate selection of candidates. We have three-iale engagement models for the cleoloyment
					</p>
				</div>
				...
				<div class="col-md-4 col-12" data-aos="zoom-in" data-aos-offset="300" data-aos-delay="50" data-aos-duration="1000" data-aos-delay="50" data-aos-duration="1000">
					...
					<div class="para_about">
						We employ systematic research methods and conduct an in-depth analysis to hire the best & exceptional human assets for our clients.
					</div>
				</div>
			</div>
		</div>
