			...
			<div class="row">
					...
					<div class="row">
						...
						<div class="col-12 col-sm-12 col-lg-8">
							<div class="delpoy_text_yellow">
								Oracle E-Business Suite and PeopleSoft support and maintenance :
							</div>
				...
				<div class="col-md-6 padd-5" data-aos="zoom-in" data-aos="fade-right" data-aos-offset="50" data-aos-delay="10" data-aos-duration="500">
					<div class="row">
						...
						<div class="col-12 col-sm-12 col-lg-8">
							<div class="delpoy_text_yellow">
								Big data platform support and maintenance:
							</div>
							<div class="para_about">
								Expert support & maintenance for big data platforms incl. Hadoop, Spark, & more.
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-6 padd-5"  data-aos="zoom-in" data-aos="fade-right" data-aos-offset="50" data-aos-delay="10" data-aos-duration="500">
					<div class="row">
						...
						<div class="col-12 col-sm-12 col-lg-8">
							<div class="delpoy_text_yellow">
								Hyperion support and maintenance:
							</div>
							<div class="para_about">
								We have robust experience and exposure in offering expert Hyperion support and maintenance.
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-6 padd-5"  data-aos="zoom-in" data-aos="fade-right" data-aos-offset="50" data-aos-delay="10" data-aos-duration="500">
					<div class="row">
						...
						<div class="col-12 col-sm-12 col-lg-8">
							...
							<div class="para_about">
								We enable cloud migration & integration for scalable, flexible, cost-effective systems.
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row padd-10">
				<div class="col-md-7" data-aos="fade-right" data-aos="fade-right" data-aos-offset="50" data-aos-delay="10" data-aos-duration="500">
					...
					<p class="para_about white_color">
						Reimagine the IT Services Management experience to achieve technological prowess with Fixity. We are committed to offering seamless IT support to our clients by helping them -
					</p>
					<p class="para_about white_color">
						<ul>
							<li class="white_color">-Build a diverse and sophisticated enterprise application and technology portfolio.</li>
							<li class="white_color">-Balance competing for business priorities around operation vs. innovation.</li>
							<li class="white_color">- Resolve staffing conflicts between project delivery and support.</li>
							<li class="white_color">- Transform from a "people-based" support model to a "process-based" support model.</li>
						</ul>
					</p>
				</div>
	...
	<section class="career_sec5">
		<div class="container">
			<div class="it_sol_cta">
				Want to optimize your <strong>Oracle E-Business Suite, PeopleSoft, Hyperion, and other big data platforms </strong> but don't know where to start? Our team is here to help. Reach out to us today to learn more about us and the responsive IT solutions offered by us.
