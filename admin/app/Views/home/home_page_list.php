...
<div class="nk-content ">
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                ...
                                                <h4 class="nk-block-title">Home Page Logo List</h4>
                            ...
                            <div class="card card-preview">
                                <div class="card-inner">
                                       ...
                                       <div style="float:right;">
                                                 <a href="javascript:void(0)" class="btn btn-primary d-none d-md-inline-flex" id="home-modal" ><em class="icon ni ni-plus"></em><span>Add</span></a>
                                    ...
                                    <table class="datatable-init table" id="home_table"> 
                                                    <thead>
                                                        <tr>
               ...
               <div class="modal fade" id="logoAdd">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" id="home_logo" enctype="multipart/form-data">
