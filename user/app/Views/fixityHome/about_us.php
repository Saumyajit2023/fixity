...
<div class="banner_div">
		<img class="banner_img" src="<?php echo base_url('user/assets/img/about/hero_image.jpg');?>">
	</div>
				...
				<div class="row p-5 padd-bottom-10">
				  <div class="col-md-6 mb-3" data-aos="fade-right" data-aos-offset="300" data-aos-delay="50" data-aos-duration="1000" data-aos-delay="50" data-aos-duration="1000">
				    <ul class="nav nav-pills flex-column" id="experienceTab" role="tablist">
				      ...
				      <li class="nav-item">
				        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#devs" role="tab" aria-controls="profile" aria-selected="false"><strong>Visionary leadership</strong> <br>is our hallmark</a>
				      </li>
				      <li class="nav-item">
				        <a class="nav-link " id="home-tab2" data-toggle="tab" href="#snit2" role="tab" aria-controls="home" aria-selected="true"><strong>Dedicated Talent</strong> <br>Acquisition Team</a>
				      </li>
				      <li class="nav-item">
				        <a class="nav-link" id="profile-tab2" data-toggle="tab" href="#devs2" role="tab" aria-controls="profile" aria-selected="false"><strong>Fastest Turnaround </strong><br>Time</a>
				      </li>
				    </ul>
				  </div>
				  <!-- /.col-md-4 -->
