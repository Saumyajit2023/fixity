...
<div class="banner_div">
		<img class="banner_img" src="<?php echo base_url('assets/img/resource/hero/resource_hero.jpg');?>">
	</div>
	
	<section class="award_sec_1">
		<div class="container ">
